    ...
    t.fn.use = function(e, t, a) {
        function s(e, t) {
            ...
            ("load" === e.type || n.test((e.currentTarget || e.srcElement).readyState)) && (o.modules[m] = t, y.removeChild(v), function i() {
                return++ p > 1e3 * o.timeout / 4
                    ? r(m + " is not a valid module")
                    : void(o.status[m]
                        ? c()
                        : setTimeout(i, 4))
            }())
        ...
        function c() {
            ...
            e.length > 1
                ? f.use(e.slice(1), t, a)
                : "function" == typeof t && t.apply(layui, a)
        }
        var f = this,
            d = o.dir = o.dir
                ? o.dir
        ...
        e = "string" == typeof e
            ? [e]
            : e,
        window.jQuery && jQuery.fn.on && (f.each(e, function(t, n) {
            "jquery" === n && e.splice(t, 1)
        }), layui.jquery = jQuery);
        var m = e[0],
            p = 0;
        if (a = a || [], o.host = o.host || (d.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0],
        0 === e.length || layui["layui.all"] && l[m])
            return "function" == typeof t && t.apply(layui, a),
            f;
        var v = n.createElement("script"),
            h = (l[m]
                ? d + "/"
                : o.base || "") + (f.modules[m] || m) + ".js";
        return v.async = !0,
        v.charset = "utf-8",
        v.src = h + function() {
            var e = o.version === !0
        ...
        o.modules[m]
            ? !function g() {
                return++ p > 1e3 * o.timeout / 4
                    ? r(m + " is not a valid module")
                    : void("string" == typeof o.modules[m] && o.status[m]
                        ? c()
                        : setTimeout(g, 4))
            }()
            : (y.appendChild(v), !v.attachEvent || v.attachEvent.toString && v.attachEvent.toString().indexOf("[native code") < 0 || u
